...
{
    public class Car : Vehicle, IGasPump, ICarWash
    {

        public Car(int drivenKilometers, DateTime yearOfProduction, int horsePower) : base(drivenKilometers, yearOfProduction, horsePower)
        {
        }
        ...
        public void PumpGas()
        {
            ...
            Console.WriteLine($"Your fuel has {FuelTankLitters} litters");
        }
